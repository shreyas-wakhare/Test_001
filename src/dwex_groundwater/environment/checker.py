...
class EnvironmentChecker:
    ...
    def check_filesystem_and_directories(self) -> CheckResult:
        ...
        t0 = time.perf_counter()
        required_dirs = [
            self.project_root / "data" / "actual" / "raw",
            self.project_root / "data" / "actual" / "extracted",
            self.project_root / "data" / "actual" / "modflow_input",
            self.project_root / "data" / "actual" / "modflow_output",
            self.project_root / "data" / "synthetic" / "raw",
            self.project_root / "data" / "synthetic" / "extracted",
            self.project_root / "data" / "synthetic" / "modflow_input",
            self.project_root / "data" / "synthetic" / "modflow_output",
            self.project_root / "outputs" / "actual",
            self.project_root / "outputs" / "synthetic",
            self.project_root / "reports" / "actual",
            self.project_root / "reports" / "synthetic",
